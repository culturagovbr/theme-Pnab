app.component('panel--entity-tabs', {
    ...
    data() {
        let query = {};
        const pnabConfig = $MAPAS.config.panelEntityTabsPnab || {};
        const parActionOptions = Array.isArray(pnabConfig.parActionOptions)
            ? pnabConfig.parActionOptions
            : [];
        const parActionFilterEnabled = Boolean(pnabConfig.isGestorCultBr);
