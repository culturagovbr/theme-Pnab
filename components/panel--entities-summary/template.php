<?php
/**
 * Override do tema Pnab: card "Oportunidades" só visível para quem tem canAccess (UserAccessService).
...
$this->import('
    ...
    mc-link
');
$canAccessOpportunitiesPanel = UserAccessService::canAccess();
?>
<div class="panel--entities-summary">                    
    ...
    <?php if ($canAccessOpportunitiesPanel): ?>
    <!-- oportunidades (Pnab: só para quem tem canAccess) -->
