...
<mc-modal :title="modalTitle" classes="create-modal create-space-modal" button-label="<?php i::_e('Criar Espaço')?>"  @open="createEntity()" @close="destroyEntity()">
    <template v-if="entity && !entity.id" #default>
        ...
        <div class="create-modal__fields">
            ...
            <entity-field v-if="getTypeId(entity.type) === otherTypeId" :entity="entity" hide-required prop="informarQualOutroTipoDeEspaco" label="<?php i::esc_attr_e("Especificar o tipo de espaço")?>"></entity-field>
