...
return [
    ...
    'id' => i::__('ID {id}'),
    'logs' => i::__('Logs'),
    'sincronizar' => i::__('Sincronizar'),
    'confirmar' => i::__('Reenviar {total} oportunidade(s) ao CultBR? O envio entra na fila e o resultado aparece nos logs de cada edital.'),
    'confirmar_sim' => i::__('Reenviar'),
    'confirmar_nao' => i::__('Cancelar'),
    'enfileirado' => i::__('{total} oportunidade(s) enviada(s) para a fila de reenvio.'),
    ...
    'sem_oportunidades' => i::__('Nenhuma oportunidade encontrada.'),
    'status_pending' => i::__('Em andamento'),
    'status_success' => i::__('Enviada'),
