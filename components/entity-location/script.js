...
app.component('entity-location', {
    ...
    computed: {
        ...
        errorsEstado() {
            return this.entity.__validationErrors?.En_Estado || [];
        },
        errorsMunicipio() {
            return this.entity.__validationErrors?.En_Municipio || [];
        },
    },
    ...
    methods: {
        ...
        isRequired(field){
            return $DESCRIPTIONS[this.entity.__objectType][field].required || this.required;
        }
    }
});
