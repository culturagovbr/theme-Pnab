<?php
/**
 * Tema Pnab: override da view de edição do agente Individual (tipo 1).
 * Base: modules/Entities/views/agent/edit-1.php
 * Edite este arquivo para alterar o formulário do agente Individual.
 */
